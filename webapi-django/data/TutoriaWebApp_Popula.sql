...
('B', 50, 'Olá mundo', 'Se cadastrou no site.', 'OlaMundo.jpeg'),
('B', 50, 'Primeiro Contato', 'Mandou sua primeira mensagem.', 'contato.jpeg'),
('B', 100, 'Primeiro Passo', 'Realizou a primeira tutoria com sucesso.', 'passo.jpeg'),
('B', 150, 'Networking Inicial', 'Mandou mensagem para 5 usuários diferentes.', 'networking.jpeg'),
('B', 150, 'Primeira Impressão', 'Recebeu sua primeira avaliação como tutor ou aprendiz.', 'impressao.jpeg'),
('B', 100, 'Caminho das Pedras I', 'Participou de 5 sessões de tutoria.', 'caminho1.jpeg'),
('B', 150, 'O que?! Quer uma medalha?', 'Conseguiu alcançar o nível 5.', 'querUmaMedalha.jpeg'),
('P', 300, 'Volte Sempre', 'Recebeu sua primeira avaliação 5 estrelas como tutor.', 'volteSempre.jpeg'),
('P', 300, 'O prazer foi meu', 'Recebeu sua primeira avaliação 5 estrelas como aprendiz.', 'prazer.jpeg'),
('P', 350, 'Fidelidade', 'Realizou 5 ou mais tutorias com o mesmo tutor.', 'fidelidade.jpeg'),
('P', 500, 'Pau pra Toda Obra', 'Forneceu tutoria em 3 áreas de conhecimento diferente.', 'todaObra.jpeg'),
('P', 350, 'Caminho das Pedras II', 'Participou de 15 sessões de tutoria.', 'caminho2.jpeg'),
('P', 600, 'Caminho das Pedras III', 'Participou de 30 sessões de tutoria.', 'caminho3.jpeg'),
('P', 500, 'Interessante...', 'Conseguiu alcançar o nível 10', 'interessante.jpeg'),
('O', 800, 'Feedback de Peso', 'Recebeu 3 avaliações com comentário > 100 caracteres.', 'feedback.jpeg'),
('O', 900, 'Incansável', 'Participou de tutorias por 5 dias seguidos.', 'incansavel.jpeg'),
('O', 1200, 'Veterano da Plataforma', 'Concluiu 50 tutorias em uma única especialidade.', 'veterano.jpeg'),
('O', 1100, 'Caminho das Pedras IV', 'Participou de 60 sessões de tutoria.', 'caminho4.jpeg'),
('O', 1400, 'Caminho das Pedras V', 'Participou de 100 sessões de tutoria.', 'caminho5.jpeg'),
('O', 1200, 'O que você quer provar?', 'Conseguiu alcançar o nível 25.', 'oQueVoceQuerProvar.jpeg'),
('D', 2500, 'Caminho das Pedras VI', 'Participou de 300 sessões de tutoria.', 'caminho6.jpeg'),
('D', 3000, 'Lenda', 'Conseguiu alcançar o nível 50.', 'Lenda.jpeg');

INSERT INTO CONQUISTA (tier, pontos, titulo, descricao, urlImagem, secreta, pista) VALUES
('B', 150, 'Agora é minha vez!', 'Se tornou um tutor.', 'minhavez.jpeg', true, 'Quem aprende também pode ensinar...'),
('B', 200, 'Fim de Semana Ativo', 'Realizou uma tutoria em final de semana.', 'fimdesemana.jpeg', true, 'O conhecimento não tira folga no sábado ou domingo...'),
('P', 400, 'Coruja', 'Realizou uma tutoria na madrugada (22h às 05h).', 'coruja.jpeg', true, 'Para aqueles cujas mentes brilham sob o luar...'),
('P', 450, 'Guerreiro do Feriado', 'Realizou uma tutoria em um feriado nacional.', 'guerreiro.jpeg', true, 'Enquanto todos descansam, você evolui...'),
('O', 850, 'Estrela Ascendente', 'Recebeu 5 avaliações 5 estrelas.', 'estrela.jpeg', true, 'Um céu bonito é cheio de estrelas...'),
('O', 1000, 'Mestre Bem-Avaliado', 'Manteve uma média ≥ 4.7 como tutor após 10 avaliações.', 'bemAvaliado.jpeg', true, 'A excelência é reconhecida pelos seus aprendizes...'),
('O', 800, 'O Nascimento do Conhecimento', 'Participou de uma tutoria no seu aniversário.', 'nascimento.jpeg', true, 'Nesse dia tão especial, seu presente é o conhecimento!'),
('D', 1600, 'Mestre das Estrelas', 'Recebeu 15 avaliações 5 estrelas.', 'mestreEstrelas.jpeg', true, 'Seu ensino tem uma constelação própria!'),
('D', 2000, 'Deixando uma Marca', 'Manteve uma média ≥ 4.7 como tutor ou aprendiz após 80 avaliações.', 'marca.jpeg', true, 'Um legado gravado na história do sistema...');
