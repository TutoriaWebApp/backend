# Generated by Django 5.2.7 on 2026-08-26 22:11
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('sobremim', models.CharField(blank=True, db_default=None, default=None, max_length=500, null=True)),
        ...
        migrations.CreateModel(
            ...
            options={
                ...
                'constraints': [models.UniqueConstraint(condition=models.Q(('estado__in', ['PENDENTE', 'ACEITO', 'RECORRENTE'])), fields=('usuarioId', 'agendaId', 'dataPretendida'), name='unique_solicitacao_ativa')],
            },
        ),
