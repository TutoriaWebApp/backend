...
('B', 50, 'Primeiro Contato', 'Mandou sua primeira mensagem.', ''),
('B', 100, 'Primeiro Passo', 'Realizou a primeira tutoria com sucesso.', ''),
('B', 150, 'Networking Inicial', 'Mandou mensagem para 5 usuários diferentes.', ''),
('B', 150, 'Primeira Impressão', 'Recebeu sua primeira avaliação como tutor ou aprendiz.', ''),
('B', 100, 'Caminho das Pedras I', 'Participou de 5 sessões de tutoria.', ''),
('B', 150, 'O que?! Quer uma medalha?', 'Conseguiu alcançar o nível 5.', ''),
('P', 300, 'Volte Sempre', 'Recebeu sua primeira avaliação 5 estrelas como tutor.', ''),
('P', 300, 'O prazer foi meu', 'Recebeu sua primeira avaliação 5 estrelas como aprendiz.', ''),
('P', 350, 'Fidelidade', 'Realizou 5 ou mais tutorias com o mesmo tutor.', ''),
('P', 500, 'Pau pra Toda Obra', 'Forneceu tutoria em 3 áreas de conhecimento diferente.', ''),
('P', 350, 'Caminho das Pedras II', 'Participou de 15 sessões de tutoria.', ''),
('P', 600, 'Caminho das Pedras III', 'Participou de 30 sessões de tutoria.', ''),
('P', 500, 'Interessante...', 'Conseguiu alcançar o nível 10', ''),
('O', 800, 'Feedback de Peso', 'Recebeu 3 avaliações com comentário > 100 caracteres.', ''),
('O', 900, 'Incansável', 'Participou de tutorias por 5 dias seguidos.', ''),
('O', 1200, 'Veterano da Plataforma', 'Concluiu 50 tutorias em uma única especialidade.', ''),
('O', 1100, 'Caminho das Pedras IV', 'Participou de 60 sessões de tutoria.', ''),
('O', 1400, 'Caminho das Pedras V', 'Participou de 100 sessões de tutoria.', ''),
('O', 1200, 'O que você quer provar?', 'Conseguiu alcançar o nível 25.', ''),
('D', 2500, 'Caminho das Pedras VI', 'Participou de 300 sessões de tutoria.', ''),
...
('B', 150, 'Agora é minha vez!', 'Se tornou um tutor.', '', true, 'Quem aprende também pode ensinar...'),
('B', 200, 'Fim de Semana Ativo', 'Realizou uma tutoria em final de semana.', '', true, 'O conhecimento não tira folga no sábado ou domingo...'),
('P', 400, 'Coruja', 'Realizou uma tutoria na madrugada (22h às 05h).', '', true, 'Para aqueles cujas mentes brilham sob o luar...'),
('P', 450, 'Guerreiro do Feriado', 'Realizou uma tutoria em um feriado nacional.', '', true, 'Enquanto todos descansam, você evolui...'),
('O', 850, 'Estrela Ascendente', 'Recebeu 5 avaliações 5 estrelas.', '', true, 'Um céu bonito é cheio de estrelas...'),
('O', 1000, 'Mestre Bem-Avaliado', 'Manteve uma média ≥ 4.7 como tutor após 10 avaliações.', '', true, 'A excelência é reconhecida pelos seus aprendizes...'),
('O', 800, 'O Nascimento do Conhecimento', 'Participou de uma tutoria no seu aniversário.', '', true, 'Nesse dia tão especial, seu presente é o conhecimento!'),
('D', 1600, 'Mestre das Estrelas', 'Recebeu 15 avaliações 5 estrelas.', '', true, 'Seu ensino tem uma constelação própria!'),
('D', 2000, 'Deixando uma Marca', 'Manteve uma média ≥ 4.7 como tutor ou aprendiz após 80 avaliações.', '', true, 'Um legado gravado na história do sistema...');
